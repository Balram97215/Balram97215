...
| **Languages & Scripting** | **Governance & Strategy** | **Data Viz & Tools** |
| :--- | :--- | :--- |
| ![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) **Python** (Pandas, NumPy) | 🛡️ **Master Data Mgmt (MDM)** | ![Power BI](https://img.shields.io/badge/Power_BI-F2C811?style=flat-square&logo=powerbi&logoColor=black) **Power BI** (DAX) |
| ![SQL](https://img.shields.io/badge/SQL-CC2927?style=flat-square&logo=microsoft-sql-server&logoColor=white) **SQL** (T-SQL, PostgreSQL) | 📋 **SOP Development** | ![Excel](https://img.shields.io/badge/Excel-217346?style=flat-square&logo=microsoft-excel&logoColor=white) **Advanced Excel** |
| 🤖 **Machine Learning** (Scikit-learn) | 🔍 **Root Cause Analysis** | 📊 **Matplotlib / Seaborn** |
